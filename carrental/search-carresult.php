...
$sql = "SELECT id from tblvehicles where tblvehicles.brandid=:brand and tblvehicles.fueltype=:fueltype";
...
$sql = "SELECT tblvehicles.*,tblbrands.brandid,tblbrands.brandid from tblvehicles join tblbrands on tblbrands.brandid=tblvehicles.brandid where tblvehicles.brandid=:brand and tblvehicles.fueltype=:fueltype";
$query = $dbh -> prepare($sql);
$query -> bindParam(':brand',$brand, PDO::PARAM_STR);
$query -> bindParam(':fueltype',$fueltype, PDO::PARAM_STR);
$query->execute();
